...
# Set up logging
log_file = "/home/ncacord/N.E.X.U.S.-Server/shared/logs/download_t5-large.log"
...
model_path = Path("/home/ncacord/N.E.X.U.S.-Server/shared/models/t5-large")
...
if not model_files_exist:
    ...
    model = AutoModelForSeq2SeqLM.from_pretrained("t5-large", torch_dtype=torch_dtype)
    ...
    model = AutoModelForSeq2SeqLM.from_pretrained(model_path, torch_dtype=torch_dtype)

# Move model to the specified device
model = model.to(device)

# Example sentence for sequence-to-sequence language modeling
input_sentence = "Translate this sentence to French."
